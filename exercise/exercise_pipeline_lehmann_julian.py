...
def collect_image_paths(data_dir):
    ...
    crawler_ = futil.FileSystemDataCrawler('C:/Users/julia/Documents/BME/Semester_3/Medical Image Analysis_LAB/MIALab/data/exercise',
...
def preprocess_filter_rescale_t1(image_dict, new_min_val, new_max_val):
    ...
    minmax_rescaled_img = filter_.execute(image_dict[structure.BrainImageTypes.T1w], filter_params)  # todo: modify here
...
def extract_feature_median_t1(image_dict):
    ...
    median_img = filter_.execute(image_dict[structure.BrainImageTypes.T1w])  # todo: modify here
