...
UBELIX (CentOS) 
---------------
The installation is similar to the Linux installation with some important differences. General UBELIX help is available on the `UBELIX 101 page <https://docs.id.unibe.ch/ubelix/ubelix-101>`__.

#. Connect to UBELIX
   
   - Make sure you have an UBELIX account otherwise create one
   - :bash:`ssh <your_username>@submit.unibe.ch`
   - Enter the password
